...
def get_complete_chart(dob, tob, lat=28.6139, lon=77.2090):
    ...
    # --- 🛠️ ERROR FIX: float to integer conversion ---
    # यहाँ int() लगाने से 'float object' वाला एरर 100% खत्म हो जाएगा
    ...
    # --- विस्तृत पंचांग सिस्टम (पूरी लिस्ट सुरक्षित है) ---
